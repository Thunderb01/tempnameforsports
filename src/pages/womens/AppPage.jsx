...
function RosterStrengthPanel({ calc, onOpenModal, allPlayers = [], teamFreshmenAll = [], userTeam = "", customOrder, setCustomOrder, starterCounts, setStarterCounts }) {
  ...
  const teamScores = useMemo(() => {
    ...
    // Official team freshmen raise each team's baseline.
  ...
  return (
    <>
      ...
      <div className="app-shell">
        ...
        {viewMode === "strength" && <RosterStrengthPanel calc={calc} onOpenModal={handleOpenModal} allPlayers={board.state.board} teamFreshmenAll={board.allTeamFreshmen} userTeam={activeTeam} customOrder={depthChartOrder} setCustomOrder={setDepthChartOrder} starterCounts={depthStarterCounts} setStarterCounts={setDepthStarterCounts} />}
